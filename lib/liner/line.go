...
mainLoop:
	...
	haveNext:
		...
		case rune:
			...
			case ctrlA: // Start of line
				if s.keyBindings != nil {
					if handler, ok := s.keyBindings["ctrl-a"]; ok {
						handler(s)
						s.needRefresh = true
						break
					}
			...
			case ctrlE: // End of line
				if s.keyBindings != nil {
					if handler, ok := s.keyBindings["ctrl-e"]; ok {
						handler(s)
						s.needRefresh = true
						break
					}
			...
			case ctrlB: // left
				if s.keyBindings != nil {
					if handler, ok := s.keyBindings["ctrl-b"]; ok {
						handler(s)
						s.needRefresh = true
						break
					}
			...
			case ctrlF: // right
				if s.keyBindings != nil {
					if handler, ok := s.keyBindings["ctrl-f"]; ok {
						handler(s)
						s.needRefresh = true
						break
					}
			...
			case ctrlP: // up
				if s.keyBindings != nil {
					if handler, ok := s.keyBindings["ctrl-p"]; ok {
						handler(s)
						s.needRefresh = true
						break
					}
			...
			case ctrlN: // down
				if s.keyBindings != nil {
					if handler, ok := s.keyBindings["ctrl-n"]; ok {
						handler(s)
						s.needRefresh = true
						break
					}
			...
			case ctrlR: // Reverse Search
				if s.keyBindings != nil {
					if handler, ok := s.keyBindings["ctrl-r"]; ok {
						handler(s)
						s.needRefresh = true
						break
					}
		...
		case action:
			...
			case f1:
				if s.keyBindings != nil {
					if handler, ok := s.keyBindings["f1"]; ok {
						handler(s)
						s.needRefresh = true
						break
					}
			...
			case f2:
				if s.keyBindings != nil {
					if handler, ok := s.keyBindings["f2"]; ok {
						handler(s)
						s.needRefresh = true
						break
					}
			...
			case f3:
				if s.keyBindings != nil {
					if handler, ok := s.keyBindings["f3"]; ok {
						handler(s)
						s.needRefresh = true
						break
					}
